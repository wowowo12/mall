...
furniture[0][2] = "Mentel Clocks";
furniture[1][2] = "Paper Shakers";
furniture[2][2] = "Oil Vineager Sets";
furniture[3][2] = "Interior Lightening";
...
// 	$(this).find("h5").stop().slideDown(100);
// }, function(){
// 	$(this).find("h5").stop().slideUp(100);
// });

//hover하면 text가 나타나고 이미지가 커지는 애니메이션 처리
$(".featured_item").hover(function(){
